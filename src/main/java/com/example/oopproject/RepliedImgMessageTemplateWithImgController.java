...
public class RepliedImgMessageTemplateWithImgController implements Initializable {
    private Stage stage;
    private Scene scene;
    private Parent root;
    @FXML
    ...
    public void setData(String repliedMessage , String senderName , String time , String typingMessage
                        ,String repliedImageUrl , String ImageUrl) throws SQLException {
        if(!checkIfTheMessageIsDeleted(repliedMessageID)) {
            ...
            Image image2 = new Image(repliedImageUrl);
            repliedImage.setImage(image2);
        }
        else{
                    ...
                    public void handle(MouseEvent mouseEvent) {
                        ...
                        if (mouseEvent.isPrimaryButtonDown() && mouseEvent.getClickCount() == 1) {
                            ...
                            if(!MainController.isInGroupModeChat) {
                                ...
                                PrivateChatSceneController.repliedMessageType = "withimage";
                                ...
                                GroupChatSceneController.repliedMessageType = "withimage";
