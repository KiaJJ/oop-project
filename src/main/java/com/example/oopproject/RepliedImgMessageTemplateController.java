...
public class RepliedImgMessageTemplateController implements Initializable {
    private Stage stage;
    private Scene scene;
    private Parent root;
    @FXML
    ...
    public void setData(String repliedMessage , String senderName , String time , String typingMessage
            ,String repliedImageUrl ) throws SQLException {
        if(!checkIfTheMessageIsDeleted(repliedMessageID)) {
            ...
            this.time.setText(time);
            this.typingMessage.setText(typingMessage);
            //Image image2 = new Image(getClass().getResourceAsStream(repliedImageUrl));
