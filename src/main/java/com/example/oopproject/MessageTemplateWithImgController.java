...
public class MessageTemplateWithImgController implements Initializable {
    private Stage stage;
    private Scene scene;
    private Parent root;
    @FXML
    ...
    public void setTheMessageLabelText(String typingMessage , String name , String currentTime , String imageAddress){
